            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="bookingType bg-ashs">
                        ...
                        <div style="background-image: url('ccss/star-1-3/Static%20HTML/img/bg-menuReserva6.jpg'); position: relative; z-index: 1; -webkit-box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); -moz-box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); border-radius: 12px;">
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    <center><font size="5"><b FACE="arial" style="margin-left: -10px;" >Detalles de Reserva</b></font></center>
                                                                    <br />
                                                            ...
                                                            <div class="row">
                                                                <div id="Reporte">
                                                                    ...
                                                                    <b face="arial">
                                                                        <asp:Label ID="Label5" runat="server" Text="Hora: " Style="font-size: 18px;"></asp:Label>
                                                                    </b>
                                                                    ...
                                                                    <table style="margin-left: 62%;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">&nbsp;
                         <u>
                             <asp:Label ID="lblTotal" runat="server" Text="₡ 11.000" Style="font-size: 16px;"></asp:Label></u>
                                                                            </td>
                                                                        </tr>
