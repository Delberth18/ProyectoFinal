<%@ Page Title="" Language="C#" MasterPageFile="~/Site4.Master" AutoEventWireup="true" CodeBehind="reservaClases.aspx.cs" Inherits="SurfTribeSystem1._0.reservaClases" %>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="bookingType bg-ashs">
                            ...
                            <div class="steps-row-2 setup-panel-2 d-flex justify-content-between">
                                <div class="steps-step-2">
                                    <a style="cursor: auto; background-color: #6E81AD !important; color: white !important;"
                                        class="btn btn-amber btn-circle-2 waves-effect ml-0" title="Destino"><i class="fa fa-map-marker"></i></a>
                                </div>
                                <div class="steps-step-2">
                        ...
                        <br />
                        <br />
                        <div style="background-image: url('ccss/star-1-3/Static%20HTML/img/bg-reserva.jpg'); position: relative; z-index: 1; -webkit-box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); -moz-box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); border-radius: 12px;">
                                                    ...
                                                    <div class="recentActivityContent bg-ashs">
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <br />
                                                                    <center><font size="5"><b FACE="arial">Seleccione su destino</b></font></center>
                                                                    <br />
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <map name="image-map">
                                                                    ...
                                                                    <li class="li">
                                                                        ...
                                                                        <a class="link"><i></i></a>
                                                                        <a class="link">
                                                                            <area target="" alt="Guanacaste" title="Guanacaste" href="reservaEscuelas.aspx?nombreUbicación=GUANACASTE" coords="185,150,194,143,197,134,193,127,186,120,178,115,169,111,162,105,159,95,152,89,143,88,136,82,127,80,120,82,113,76,107,69,97,66,91,61,94,54,98,49,105,45,111,43,116,37,122,35,117,28,110,24,103,22,94,22,85,18,77,16,72,9,63,6,58,11,56,18,52,24,48,30,53,35,48,39,41,39,46,45,48,51,39,54,32,58,27,51,21,55,13,58,18,63,24,67,29,68,34,73,39,75,47,74,52,80,53,87,54,93,51,101,50,107,58,102,58,108,51,113,44,118,35,118,32,123,34,130,33,136,26,140,22,146,25,152,24,159,24,166,25,172,29,178,32,184,33,191,38,196,43,204,47,208,51,213,53,219,58,222,64,225,71,227,79,227,84,231,91,229,97,232,104,233,109,238,115,240,118,245,126,247,128,234,127,227,118,221,110,219,113,210,120,210,127,210,130,203,126,195,121,188,117,180,116,171,116,162,123,170,126,176,133,178,135,178,146,180,154,177,161,178,165,180,171,185,177,176,178,169,179,165,180,155,185,150,161,178,185,150,193,151,195,133" shape="poly">
                                                                        </a>
                                                                    ...
                                                                    <li class="li">
                                                                        ...
                                                                        <a class="link"><s></s></a>
                                                                        <a class="link">
                                                                            <area target="" alt="Limón" title="Limón" href="reservaEscuelas.aspx?nombreUbicación=LIMON" coords="406,308,403,298,401,290,396,283,397,274,401,267,406,261,411,253,414,246,420,241,425,234,424,225,422,216,427,210,418,207,411,208,401,209,392,208,384,208,375,203,365,199,357,196,349,194,342,188,332,184,331,177,335,170,341,164,343,156,342,147,339,140,343,132,346,124,344,115,345,108,346,100,352,95,359,94,365,93,359,85,362,77,368,76,373,69,371,57,377,58,382,64,384,74,386,80,381,86,387,88,389,95,393,102,396,109,399,117,402,124,405,131,408,134,412,139,416,145,420,151,422,156,427,161,432,168,440,178,446,183,450,189,456,196,459,202,465,206,476,208,477,213,481,220,488,226,491,232,495,239,501,244,507,251,510,255,517,263,527,265,535,267,543,272,549,279,542,285,535,286,527,282,520,273,509,269,499,272,504,286,496,289,489,295,490,303,489,317,491,337,489,353,472,340,470,330,460,322,454,315,441,314,428,305,421,312,413,310" shape="poly">
                                                                        </a>
