<%@ Page Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="registroUsuario.aspx.cs" Inherits="SurfTribeSystem1._0.registroUsuario" %>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="sectionTitle">
                            <h2>
                                <asp:Label runat="server" ID="tituloLabel" Text="registro de usuarios" BackColor="#f5f5f5" Font-Size="XX-Large"></asp:Label></h2>
                ...
                <div class="container" style="background-image: url('ccss/star-1-3/Static%20HTML/img/bg-menuReserva.jpg'); position: relative; z-index: 1; -webkit-box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); -moz-box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); border-radius: 12px; padding: 12px;">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <ul>
                                <li>
                                    ...
                                    <br />
                                    <asp:TextBox ID="txtNombre" runat="server" class="form-control  bg-ashh"></asp:TextBox>
                                </li>
                                <li>
                                    <br />
                                </li>
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <ul>
                                <li>
                                    <label style="color: SaddleBrown; font-size: x-large">Apellidos:</label>
                                    <br />
                                    <asp:TextBox ID="txtApellidos" runat="server" class="form-control  bg-ashh"></asp:TextBox>
                                </li>
                                <li>
                                    <br />
                                </li>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <ul>
                                <li>
                                    <label style="color: SaddleBrown; font-size: x-large">Teléfono:</label>
                                    <br />
                                    <asp:TextBox ID="txtTelefono" runat="server" class="form-control  bg-ashh" TextMode="Number"></asp:TextBox>
                                </li>
                            </ul>
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <ul>
                                <li>
                                    <label style="color: SaddleBrown; font-size: x-large">Pais:</label>
                                    <br />
                                    <asp:DropDownList ID="paisesList" runat="server" class="form-control bg-ashh">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <ul>
                                <li>
                                    ...
                                    <br />
                                    <asp:DropDownList ID="escuelasList" runat="server" class="form-control  bg-ashh">
                                    </asp:DropDownList>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <ul>
                                <li>
                                    <br />
                                    <label style="color: SaddleBrown; font-size: x-large">Tipo Usuario:</label>
                                    <br />
                                    <asp:DropDownList ID="tipoUsuList" runat="server" class="form-control  bg-ashh"></asp:DropDownList>
                                </li>
                                <li>
                                    <br />
                                    <label style="color: SaddleBrown; font-size: x-large">Contraseña:</label>
                                    <br />
                                    <asp:TextBox ID="txtContraseña" runat="server" class="form-control  bg-ashh" TextMode="Password"></asp:TextBox>
                                </li>
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <ul>
                                ...
                                <li>
                                    <asp:Button ID="btnGuardar" class="btn btn-default btn-circle-2 " OnClick="btnGuardar_Click" BackColor="darkorange" ForeColor="White" runat="server" Text="Guardar" Width="80%" />
                                </li>
                            </ul>
                        </div>
                    </div>
