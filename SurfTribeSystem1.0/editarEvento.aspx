<%@ Page Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="editarEvento.aspx.cs" Inherits="SurfTribeSystem1._0.editarEvento" %>
                ...
                <div class="form-group" style="box-shadow: -11px 9px 45px 2px rgba(0,0,0,0.75); border-radius: 12px; padding: 12px; padding: 15px 15px 15px 15px; width: 100%; background-color: white; background-image: url('ccss/star-1-3/Static%20HTML/img/bg-menuReserva.jpg');">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-3">
                            <ul>
                                <li>
                                    <asp:Button class="btn btn-default" ID="btnGuardar" OnClick="btnGuardar_Click" runat="server" Style="padding: 15px; background-color: darkorange; color: white; font-family: Arial; text-transform: none; font-size: large; "
                                        Text=" Guardar cambios "></asp:Button>
                        ...
                        <div class=" col-md-12">
                            <ul>
                                <li>
                                    ...
                                    <asp:TextBox Rows="7" class="form-control bg-ashh" TextMode="MultiLine" ID="dscText2" runat="server" placeholder="Escriba la descripción" /><br />
                                </li>
                            </ul>
                        </div>
                    </div>
