  ...
  <div class="container">
        ...
        <div class="recentActivityContent bg-ashs">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                      <asp:ImageButton ID="ImageButton1" OnClick="ImageButton1_Click" runat="server" Style="margin-left: -980px;  width: 40px;" src="ccss/star-1-3/Static%20HTML/img/atras.png" />
                        <br /><br />
