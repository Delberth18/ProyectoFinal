...
{
    public partial class reporteUsuarioG : System.Web.UI.Page
    {
        ...
        private void ListarEscuelas()
        {
            ...
            try
            {
                ...
                if (resultado.TipoResultado == "OK")
                {
                    ...
                    listaEscuelas.Add(new Escuela { Nombre = "Seleccione una escuela", Id = "Seleccione una escuela" });
        ...
        protected void reporteEscuela(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string escuela = escuelaLst.SelectedValue;
                string pais = paisLst.SelectedValue;
                string estado = estadoLst.SelectedValue;

                if (escuela == "Seleccione una escuela")
                {
                    escuela = "";
                }
                ...
                resultado = new UsuarioLogica().Reporte(pais,escuela,estado);
                if (resultado.TipoResultado == "OK")
                {
                    listaUsuarios = null;
        ...
        protected void GenerarReporte(object sender, EventArgs e)
        {
            ...
            doc.Add(new Paragraph("Detalles de usuarios" , fuenteT));
            Font fuent = new Font();
            fuent.Size = 10;
