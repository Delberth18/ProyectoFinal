...
namespace SurfTribeSystem_Datos
{
    public class Conexion
    {
        ...
        public string CadenaConexion()
        {
           ...
           //return @"Data Source = laptop-r7vb3im9\mssqlserver01; Initial Catalog = SURF_TRIBE; Integrated Security = True";//Eduardo No BORRAR.....que pasa si lo borro, soy delberth y me la como mm? jaja;
        }
